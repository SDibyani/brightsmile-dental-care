...
export default function AboutSection() {
  ...
  // Duplicate ticker items to guarantee seamless infinite loop
  const duplicatedTickerData = [
    ...SERVICES_TICKER_DATA,
    ...SERVICES_TICKER_DATA,
    ...SERVICES_TICKER_DATA,
  ];
    ...
    <div className="bg-slate-50 overflow-hidden">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          {/* Left Column: Shaped Image Montage - Coming from LEFT */}
          <motion.div
          ...
          {/* Right Column: Hero Content - Coming from RIGHT */}
          <motion.div
            initial={{ opacity: 0, x: 60 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, margin: "-50px" }}
      ...
      {/* 2. Services Infinite Moving Ticker Bar */}
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {VISION_MISSION_DATA.map((card, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-xl transition-all"
              >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        <div className="relative">
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-50px" }}
            transition={{ duration: 0.8, ease: "easeOut" }}
            className="relative h-[320px] sm:h-[450px] lg:h-[500px] rounded-3xl overflow-hidden shadow-2xl"
          >
            <Image
          ...
          <motion.div
            ...
            className="mt-6 md:mt-0 md:absolute md:-bottom-12 md:left-1/2 md:-translate-x-1/2 w-full md:w-[90%] bg-blue-600 rounded-2xl shadow-xl p-6 text-white"
          >
