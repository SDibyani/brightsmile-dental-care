...
export default function HeroSection() {
  ...
  return (
    <section className="relative bg-[#f8faff] py-8 sm:py-12 lg:py-16 overflow-hidden text-slate-800">
      ...
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-6 space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <Link
              href="/booking"
              className="inline-flex items-center gap-2 bg-blue-600 text-white text-sm font-bold px-7 py-4 rounded-full hover:bg-blue-700 transition shadow-lg shadow-blue-600/30 active:scale-95"
            >
              <Calendar size={18} />
              BOOK APPOINTMENT
            </Link>
      ...
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 mt-12 sm:mt-16 relative z-20">
